...
NA stands for not available. We are getting this as the answer for the mean because many of the n_2022 values are not available and therefore a mean cannot be calculated.
...
There is a small amount of very large numbers which increases the value of the mean
